...
[🌐 Live Production Website](https://theskycast.vercel.app) • [⚡ Live Backend API](https://skycast-weather-backend.onrender.com/api/health) • [API Documentation](#-rest-api-reference) • [Architecture](#-system-architecture)
