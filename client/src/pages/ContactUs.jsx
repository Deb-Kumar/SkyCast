              ...
              <div className="pt-2 border-t border-white/10">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  {[
                    ...
                    { name: 'Instagram', href: 'https://instagram.com/alexx__285', icon: Instagram, className: 'social-icon-instagram hover:text-pink-500 dark:hover:text-pink-400 hover:bg-pink-500/10 hover:border-pink-500/30' },
                    ...
                    { name: 'YouTube', href: 'https://youtube.com/@alexxxgmr', icon: Youtube, className: 'social-icon-youtube hover:text-rose-500 dark:hover:text-rose-400 hover:bg-rose-500/10 hover:border-rose-500/30' }
                  ].map((s) => {
                    const Icon = s.icon;
                    return (
                      <a
