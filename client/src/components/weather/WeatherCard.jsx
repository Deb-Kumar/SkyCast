...
export const WeatherCard = () => {
  ...
  return (
    <div className="glass-panel rounded-3xl p-6 sm:p-7 relative overflow-hidden group h-full flex flex-col justify-between">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 relative z-10">
        ...
        <div className="flex items-center gap-2 self-start sm:self-auto">
          <span className="text-xs font-semibold px-3 py-1.5 rounded-xl bg-sky-500/15 text-sky-300 border border-sky-500/30 flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 my-6 items-center relative z-10">
        ...
        <div className="md:col-span-6 flex items-center gap-5">
          <div className="p-4 rounded-2xl bg-white/5 border border-white/10 shadow-inner flex-shrink-0">
            {getWeatherIcon(current.icon, 'w-16 h-16 sm:w-20 sm:h-20')}
          </div>
          <div>
            <div className="flex items-baseline">
              <span className="text-5xl sm:text-6xl lg:text-7xl font-extrabold tracking-tighter text-white">
                {formatTemperature(current.temperature, tempUnit)}
              </span>
            </div>
            <p className="text-base sm:text-lg font-semibold text-sky-200 mt-0.5">
              {current.condition}
            </p>
        ...
        <div className="md:col-span-6 grid grid-cols-2 gap-3">
          ...
          <div className="p-3.5 rounded-2xl bg-slate-900/60 border border-white/5 flex flex-col justify-between">
            <span className="text-[11px] font-semibold text-slate-400">High / Low</span>
          ...
          {/* Air Quality */}
          <div className="p-3.5 rounded-2xl bg-slate-900/60 border border-white/5 flex flex-col justify-between">
            <span className="text-[11px] font-semibold text-slate-400">Air Quality</span>
          ...
          {/* UV Index */}
          <div className="p-3.5 rounded-2xl bg-slate-900/60 border border-white/5 flex flex-col justify-between">
            <span className="text-[11px] font-semibold text-slate-400">UV Index</span>
            <div className="flex items-center gap-1.5 mt-1 text-xs sm:text-sm font-bold text-white">
              <Sun className="w-4 h-4 text-amber-400" />
              <span>{current.uvIndex} <span className="text-[11px] text-slate-400 font-normal">/ 11+</span></span>
            </div>
          </div>

          {/* Sunrise & Sunset Card */}
          <div className="p-3.5 rounded-2xl bg-slate-900/60 border border-white/5 flex flex-col justify-between">
            <span className="text-[11px] font-semibold text-slate-400">Sunrise & Sunset</span>
            <div className="grid grid-cols-2 gap-2 mt-1">
              <div className="flex items-center gap-1.5 min-w-0">
                ...
                <div className="min-w-0">
                  <span className="text-[9px] uppercase font-bold text-slate-400 block leading-tight">Sunrise</span>
                  <span className="text-xs sm:text-sm font-bold text-white block leading-tight truncate">
              ...
              <div className="flex items-center gap-1.5 min-w-0">
                ...
                <div className="min-w-0">
                  <span className="text-[9px] uppercase font-bold text-slate-400 block leading-tight">Sunset</span>
                  <span className="text-xs sm:text-sm font-bold text-white block leading-tight truncate">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 pt-5 border-t border-white/10 relative z-10">
        <div className="p-3 rounded-2xl bg-slate-900/50 border border-white/5 flex items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="text-[10px] uppercase font-bold tracking-wider text-slate-400 truncate">Humidity</p>
            <p className="text-sm font-bold text-white mt-0.5">{current.humidity}%</p>
          </div>
        </div>
        ...
        <div className="p-3 rounded-2xl bg-slate-900/50 border border-white/5 flex items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="text-[10px] uppercase font-bold tracking-wider text-slate-400 truncate">Wind Speed</p>
            <p className="text-sm font-bold text-white mt-0.5">{formatWindSpeed(current.windSpeed, windUnit)}</p>
          </div>
        </div>
        ...
        <div className="p-3 rounded-2xl bg-slate-900/50 border border-white/5 flex items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="text-[10px] uppercase font-bold tracking-wider text-slate-400 truncate">Pressure</p>
            <p className="text-sm font-bold text-white mt-0.5">{current.pressure} hPa</p>
          </div>
        </div>
        ...
        <div className="p-3 rounded-2xl bg-slate-900/50 border border-white/5 flex items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="text-[10px] uppercase font-bold tracking-wider text-slate-400 truncate">Visibility</p>
            <p className="text-sm font-bold text-white mt-0.5">{current.visibility} km</p>
          </div>
        </div>
        ...
        <div className="p-3 rounded-2xl bg-slate-900/50 border border-white/5 flex items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="text-[10px] uppercase font-bold tracking-wider text-slate-400 truncate">Dew Point</p>
            <p className="text-sm font-bold text-white mt-0.5">{formatTemperature(current.dewPoint, tempUnit)}</p>
          </div>
        </div>
        ...
        <div className="p-3 rounded-2xl bg-slate-900/50 border border-white/5 flex items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="text-[10px] uppercase font-bold tracking-wider text-slate-400 truncate">Cloud Cover</p>
            <p className="text-sm font-bold text-white mt-0.5">{current.cloudCover}%</p>
          </div>
        </div>
      </div>
    </div>
